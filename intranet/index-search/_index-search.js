...
;
/* ../../mb-base.blocks/b-link/_type/b-link_type_filter.js begin */
$(document).ready(function(){
    $('.b-link_type_filter').on('click', function(){
        var toggle_element = $(this).data('toggle');
        $(this).toggleClass('active');
        $('.'+toggle_element).slideToggle();//.toggle('fast', function(){
            //this;
        //});
    });
});
/* ../../mb-base.blocks/b-link/_type/b-link_type_filter.js end */
;
/* ../../mb-base.blocks/b-site-nav/b-site-nav.js begin */
/** @requires BEM */
/** @requires BEM.DOM */

(function(undefined) {

BEM.DOM.decl('b-site-nav', {
...
/* ../../mb-base.blocks/b-site-nav/b-site-nav.js end */
;
/* ../../mb-base.blocks/b-search/b-search.js begin */
$(document).ready(function() {

//    var search = $('.b-search');
//    var dictionary = $('.b-dictionary');
//    var results = $('.b-search-results');
//    var nav = $('.b-page-nav').find('.b-simple-nav');
//    var tabs = $('.b-page-nav').find('.b-simple-nav').find('.b-simple-nav-link');
//    var results_tab = nav.find('.b-search-results-tab');
//    search.submit(function(){
//        dictionary.hide('fast');
//        tabs.removeClass('active');
//        results_tab.removeClass('disabled').addClass('active').show('fast');
//        results.show('fast');
//        return false;
//    });
});
/* ../../mb-base.blocks/b-search/b-search.js end */
;
/* ../../mb-base.blocks/b-simple-nav/b-simple-nav.js begin */
/** @requires BEM */
/** @requires BEM.DOM */

(function(undefined) {

BEM.DOM.decl('b-simple-nav', {
...
/* ../../mb-base.blocks/b-simple-nav/b-simple-nav.js end */
;
/* ../../mb-base.blocks/b-user-card/b-user-card.js begin */
/** @requires BEM */
/** @requires BEM.DOM */

(function(undefined) {

BEM.DOM.decl('b-user-card', {
...
/* ../../mb-base.blocks/b-user-card/b-user-card.js end */
;
/* ../../mb-base.blocks/b-user-info/b-user-info.js begin */
/** @requires BEM */
/** @requires BEM.DOM */

(function(undefined) {

BEM.DOM.decl('b-user-info', {
...
/* ../../mb-base.blocks/b-user-info/b-user-info.js end */
;
