...
;
/* ../../mb-base.blocks/b-collapsable-tree/b-collapsable-tree.js begin */
$(document).ready(function() {

    $('.b-collapsable-tree')
        .on('click', '.toggler', function(){
            $(this).toggleClass('collapsed');
            $(this).parents('.b-collapsable-tree').first().toggleClass('collapsed')
            return false;
        });
});

/* ../../mb-base.blocks/b-collapsable-tree/b-collapsable-tree.js end */
;
